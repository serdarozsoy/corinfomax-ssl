...
class SaveResults:
    def __init__(self, args): 
        ...
        self.tensor_folder=args.tensor_folder 
    ...
    def update_results(self, ldmi_value, train_loss, train_cov_loss, train_sim_loss, pre_curr_lr, total_norm):  
        self.results['LDMI'].append(ldmi_value)
...
def update_tensorboard(writer, ldmi_value, train_loss, train_cov_loss, train_sim_loss, pre_curr_lr, total_norm, R_eigs, epoch):
    writer.add_scalar("Train/LDMI", ldmi_value, epoch)
